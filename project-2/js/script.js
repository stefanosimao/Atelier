...
function init_player(dom_audio, song_urls, volume)
{
    ...
    setTimeout(()=>{
        ...
        dom_audio.addEventListener('volumechange', () => {document.querySelector("#slide").setAttribute('value', dom_audio.volume * 100); console.log(dom_audio.volume)});
        document.querySelector("#loud").addEventListener("click", () => {dom_audio.volume > 0.9 ? dom_audio.volume = 1.0 : dom_audio.volume += 0.2});
        document.querySelector("#low").addEventListener("click", () => {dom_audio.volume < 0.1 ? dom_audio.volume = 0.0 : dom_audio.volume -= 0.2});
        document.querySelector("#mute").addEventListener("click", () => {dom_audio.volume == 0.0 ? dom_audio.volume = 0.75 : dom_audio.volume = 0.0});
