//EJS Compiled Views - This file was automatically generated on Thu Dec 09 2021 13:50:26 GMT+0100 (Central European Standard Time)
...
try {
  ...
  with (locals || {}) {
    ...
    ; __line = 6
    ;  if (type == 'player') { 
    ; __append("/public/styleP.css ")
    ;  }else { 
    ; __append(" /public/style.css ")
    ;  } 
...
try {
  ...
  with (locals || {}) {
    ...
    ; __append("<main class=\"player\" id=\"player\">\n    <header class=\"player\" >\n        <p class=\"title rest artist\"></p>\n        <p class=\"title titleSong\"></p>  \n        <p class=\"title rest album\"></p>  \n    </header>\n    <section class=\"play buttons\">\n        <button type=\"button\" id=\"play\"></button>\n        <button type=\"button\" id=\"pause\"></button>\n    </section>\n\n</main>  \n<aside class=\"songs\" id='sidebar';> \n</aside>\n<script src=\"/socket.io/socket.io.js\"></script>\n<script src=\"../js/player.js\"></script>\n")
    ; __line = 18
  }
  return __output;
} catch (e) {
